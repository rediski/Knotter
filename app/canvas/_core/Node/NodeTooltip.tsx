...
import { Position, Node } from '@/canvas/_core/_/canvas.types';
...
export function NodeTooltip({ node, position, zoomLevel, isSelected }: NodeTooltipProps) {
    return (
        <div
            className={`
                absolute flex flex-col gap-px px-2 py-1 bg-depth-1 border-2 rounded-lg text-foreground text-xs whitespace-nowrap shadow cursor-default select-none
