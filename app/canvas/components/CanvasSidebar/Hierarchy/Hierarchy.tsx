...
import { HierarchyItem } from '@/canvas/components/CanvasSidebar/Hierarchy/HierarchyItem';

import { useHierarchy } from '@/canvas/components/CanvasSidebar/Hierarchy/useHierarchy';
